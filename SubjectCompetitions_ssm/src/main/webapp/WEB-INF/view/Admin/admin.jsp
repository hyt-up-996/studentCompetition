...
<head>
    <meta charset="UTF-8">
    <title>创新知识竞赛管理平台</title>
    <link rel="stylesheet" type="text/css" href="/EasyUI/themes/default/easyui.css">
    <link rel="stylesheet" type="text/css" href="/EasyUI/themes/icon.css">
    <link rel="stylesheet" type="text/css" href="/EasyUI/themes/color.css">
    <link rel="stylesheet" type="text/css" href='/css/xyy.css'>
...
<div data-options="region:'north',split:true" style="height:80px;" id="xyy_header">
    <div class="easyui-layout" data-options="fit:true">
        <div style="float:left;width:40%;padding:15px 0 0 15px;">
            <img src="/Img/logo.png" style="width:6%;">
            <a href="#" style="font-size:20px;color:#fff;text-decoration:none;">创新知识竞赛管理平台</a>
        </div>
        <div style="float:right;width:56%;">
            <div class="xyy_tool">
                <ul style="float:right;position: relative;right:0;margin:0;">
                    ...
                    <li><a href="#" onclick="addTab('修改密码','changePassword.html')"><i class="xyy-mima" style="position: absolute;display:block;width: 16px;height: 16px;top: 50%;margin: -8px 12px;"></i>修改密码</a></li>
                    <li><a href="index.html"><i class="xyy-tuichu" style="position: absolute;display:block;width: 16px;height: 16px;top: 50%;margin: -8px 12px;"></i>退出登录</a></li>
                </ul>
            </div>
        </div>
    </div>
</div>
<div data-options="region:'south',split:true" style="height:40px;text-align:center;line-height:30px;background:rgb(60, 70, 86);color:#f5f5f5;">创新知识竞赛管理平台  新ICP 99999999</div>
<div data-options="region:'west',title:'平台管理主菜单',split:true" style="width:200px;">
    <div id="menu" class="easyui-accordion" fit="true" border="false">
        <div title="系统设置" dat a-options="iconCls:'icon-shezhi',selected:true" style="overflow:auto;padding:10px;">
            <ul id="tt" class="easyui-tree" data-options="animate:true,lines:true">
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <span><a href="#" onclick="addTab('xx用户','index.html')">xx用户</a></span>
                        </li>
                        <li>
                            <span><a href="#" onclick="addTab('其他用户','index.html')">其他用户</a></span>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <span><a href="#" onclick="addTab('其他用户3','index.html')">其他用户3</a></span>
                        </li>
                        <li>
                            <span><a href="#" onclick="addTab('其他用户4','index.html')">其他用户4</a></span>
                        </li>
                    </ul>
                </li>
            </ul>
